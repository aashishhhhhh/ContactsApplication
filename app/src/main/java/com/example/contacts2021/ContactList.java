...
public class ContactList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // where clause to get the list of contacts in the list view
       ...
       Backendless.Persistence.of(Contact.class).find(queryBuilder, new AsyncCallback<List<Contact>>() {
           ...
           public void handleFault(BackendlessFault fault) {
            Toast.makeText(ContactList.this,"Error: "+fault,Toast.LENGTH_SHORT).show();
           }
       });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.NewContact:
                Intent in = new Intent(ContactList.this,NewContact.class);
                in.putExtra("Toast","Add New Contacts from here");
                startActivity(in);
                break;
            case R.id.Logout:
                Toast.makeText(ContactList.this,"Logout",Toast.LENGTH_SHORT).show();
                break;
