        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (etName.getText().toString().isEmpty() || etMail.getText().toString().isEmpty()||etPassword.getText().toString().isEmpty()||etReEnter.getText().toString().isEmpty()){
                    Toast.makeText(Register.this,"Enter all the feilds. Dont leave it empty",Toast.LENGTH_SHORT).show();
                    ...
                    if (etPassword.getText().toString().trim().equals(etReEnter.getText().toString().trim())){
                       ...
                       showProgress(true);
                        ...
                        Toast.makeText(Register.this,"Please make sure your password and re type password matches",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
